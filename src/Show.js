  ...
  <div className="row gx-1">
    ...
    <div className="col-6">
      <div className="d-flex justify-content-center align-items-center">
        <div className="card">
          <LazyLoadImage effect="blur" src={showimg2} className="card-img-show lazy-load-image" alt="..." />
        </div>
      </div>
    </div>
    <div className="col-6">
      <div className="d-flex justify-content-center align-items-center">
        <div className="card">
          <LazyLoadImage effect="blur" src={showimg3} className="card-img-show lazy-load-image " alt="..." />
        </div>
      </div>
    </div>
    <div className="col-6">
      <div className="d-flex justify-content-center align-items-center ">
        <div className="card">
          <LazyLoadImage effect="blur" src={showimg4} className="card-img-show lazy-load-image" alt="..." />
        </div>
      </div>
    </div>
    <div className="col-6">
      <div className="d-flex justify-content-center align-items-center">
        <div className="card">
          <LazyLoadImage effect="blur" src={showimg5} className="card-img-show lazy-load-image" alt="..." />
        </div>
      </div>
    </div>
    <div className="col-6">
      <div className="d-flex justify-content-center align-items-center">
        <div className="card">
          <LazyLoadImage effect="blur" src={showimg6} className="card-img-show lazy-load-image" alt="..." />
        </div>
      </div>
    </div>
  </div>
